...
public class AppTest {
    ...
    public void loadDriver() {
        ...
        System.setProperty("webdriver.chrome.driver", "E:\\SeleniumTesting\\driver\\chromedriver.exe");
        Object capabilities = DesiredCapabilities.chrome();
        ((DesiredCapabilities) capabilities).setBrowserName(DesiredCapabilities.chrome().getBrowserName());
